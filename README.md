...
| ✨ [GeminiCraft](https://github.com/mrnothing00/GeminiCraft) | Gemini 3 Hackathon project - an AI-powered ESP32 IoT circuit simulator with a drag-and-drop breadboard and a Gemini-powered AI tutor that debugs circuits & code in real time, plus a physics simulation engine | React · JavaScript · Gemini API |
